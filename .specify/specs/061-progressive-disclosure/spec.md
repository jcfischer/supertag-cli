...
- Should `tana_capabilities` include example prompts for each tool?
- Should we implement tool schema caching across conversations?
- Should categories be configurable or fixed?
