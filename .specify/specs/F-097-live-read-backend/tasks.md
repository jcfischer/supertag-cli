...
- [x] **T-1.1** Define TanaReadBackend interface and canonical types [T]
...
- [x] **T-2.1** Implement LocalApiReadBackend [T] (depends: T-1.1)
...
- [x] **T-2.2** Implement SqliteReadBackend [T] (depends: T-1.1)
...
- [x] **T-2.3** Implement read backend resolver [T] (depends: T-2.1, T-2.2)
...
- [x] **T-3.1** Add --offline flag to standard CLI options [T] (depends: T-2.3)
...
- [x] **T-3.2** Refactor search command FTS path [T] (depends: T-3.1)
...
- [x] **T-3.3** Refactor search command tagged path [T] (depends: T-3.1)
  - File: `src/commands/search.ts`
...
- [x] **T-3.4** Refactor nodes show command [T] (depends: T-3.1)
...
- [x] **T-3.5** Refactor tags list command [T] (depends: T-3.1)
...
- [x] **T-3.6** Refactor nodes recent command [T] (depends: T-3.1)
  - File: `src/commands/nodes.ts`
...
- [x] **T-4.1** Refactor tana_search MCP tool [T] (depends: T-2.3)
...
- [x] **T-4.2** Refactor tana_node MCP tool [T] (depends: T-2.3)
...
- [x] **T-5.1** Integration test: full read path with both backends [T] (depends: T-3.2, T-3.4, T-4.1)
...
|------|--------|---------|-----------|-------|
| T-1.1 | completed | 2026-02-05 | 2026-02-05 | src/api/read-backend.ts |
| T-2.1 | completed | 2026-02-05 | 2026-02-05 | src/api/local-api-read-backend.ts |
| T-2.2 | completed | 2026-02-05 | 2026-02-05 | src/api/sqlite-read-backend.ts |
| T-2.3 | completed | 2026-02-05 | 2026-02-05 | src/api/read-backend-resolver.ts |
| T-3.1 | completed | 2026-02-05 | 2026-02-05 | src/commands/helpers.ts --offline flag |
| T-3.2 | completed | 2026-02-05 | 2026-02-05 | src/commands/search.ts FTS path |
| T-3.3 | completed | 2026-02-05 | 2026-02-05 | src/commands/search.ts tagged path |
| T-3.4 | completed | 2026-02-05 | 2026-02-05 | src/commands/nodes.ts show |
| T-3.5 | completed | 2026-02-05 | 2026-02-05 | src/commands/tags.ts list |
| T-3.6 | completed | 2026-02-05 | 2026-02-05 | src/commands/nodes.ts recent |
| T-4.1 | completed | 2026-02-05 | 2026-02-05 | src/mcp/tools/search.ts |
| T-4.2 | completed | 2026-02-05 | 2026-02-05 | src/mcp/tools/node.ts |
| T-5.1 | completed | 2026-02-05 | 2026-02-05 | tests/read-backend-integration.test.ts |
| T-5.2 | completed | 2026-02-05 | 2026-02-05 | CLAUDE.md, README.md updated |
