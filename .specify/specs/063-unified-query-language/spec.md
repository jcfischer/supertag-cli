...
- Should we support full-text search within query? `find * where name ~ "project"`
- Should we support joins across supertags? `find task join parent:project`
- What's the syntax for OR conditions?
